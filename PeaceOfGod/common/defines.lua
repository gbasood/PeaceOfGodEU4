...
NEconomy = {
	...
	TRADE_ADDED_VALUE_MODIFER = 0.20,
...
NAI = {
	...
	BIGSHIP_FRACTION = 0.4,	-- The proportion of big ships in an AI navy of light ships and big ships (for coastal sea countries, this fraction is instead galleys)
	...
	REGIMENTS_PER_GENERAL = 30, -- At wartime, AI will want one general for every this number of regiments (min 1)
	...
	CANCEL_IMPORTANT_CONSTRUCTION_SIEGE_PROGRESS = 20, -- If chance of fort falling is at least this, AI will cancel core and culture constructions in the province
	DIPLOMATIC_INTEREST_DISTANCE = 150, -- If border distance is greater than this, AI will not consider for rivalry, protect, etc
	FORCE_MARCH_MIN_SIZE = 10, -- AI will not force march units with less regiments than this
	...
	PEACE_TERMS_ANNEX_BASE_MULT = 50.0, 
	...
	DIPLOMATIC_ACTION_FABRICATE_CLAIM_OTHER_CB_FACTOR = 0.33, -- AI scoring for fabricating claims if they already have another CB usable on the province
